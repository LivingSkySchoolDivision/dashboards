...
$(document).ready(function(){
    ...
    datatile_init("school_info_box_container", "DIV. OFFICE",1570,455, 87, [{ id: 6, label: "BUSG" },{ id: 36, label: "SRVR"},{ id: 7, label: "LS"}], [1],[
        {"name":"AD", "id": 3},
    ...
    datatile_init("school_info_box_container", "BCS", 1350, 700, 364,[{ id: 1}], [5],[
        {"name":"AD", "id": 276},
        {"name": "Alarm", "id": 116},
    ...
    datatile_init("school_info_box_container", "Bready",1140,145, 328,  [{ id: 2}], [6],[
        {"name":"AD", "id": 277},
        {"name": "Alarm", "id": 122},
    ...
    datatile_init("school_info_box_container", "CKCS",222,330, 621,  [{ id: 4, label: "SRVR"},{ id: 5, label: "STOR"}], [8],[
        {"name":"AD", "id": 279},
        {"name": "Alarm", "id": 134},
    ...
    datatile_init("school_info_box_container", "Connaught",1370,410, 246,  [{ id: 3}], [9],[
        {"name":"AD", "id": 280},
        {"name": "Alarm", "id": 138},
    ...
    datatile_init("school_info_box_container", "Hafford",801,403, 1935,  [{ id: 35}], [10],[
        {"name":"AD", "id": 281},
        {"name": "Alarm", "id": 146},
    ...
    datatile_init("school_info_box_container", "HCES",898,197, 2059,  [{ id: 8}], [11],[
        {"name":"AD", "id": 282},
        {"name": "Alarm", "id": 150},
    ...
    datatile_init("school_info_box_container", "Heritage", 1558, 700, 1563,  [{ id: 9}], [12],[
        {"name":"AD", "id": 159},
    ...
    datatile_init("school_info_box_container", "Kerrobert",348,788, 1974,  [{ id: 10}], [13],[
        {"name":"AD", "id": 283},
        {"name": "Alarm", "id": 160},
    ...
    datatile_init("school_info_box_container", "Lawrence",1330,80, 522, [{ id: 11}], [4],[
        {"name":"AD", "id": 284},
        {"name": "Alarm", "id": 165},
    ...
    datatile_init("school_info_box_container", "Leoville",630,30, 2987, [{ id: 12}], [15],[
        {"name":"AD", "id": 285},
        {"name": "Alarm", "id": 171},
    ...
    datatile_init("school_info_box_container", "Luseland",50,690, 1873, [{ id: 13}], [14],[
        {"name":"AD", "id": 286},
        {"name": "Alarm", "id": 176},
    ...
    datatile_init("school_info_box_container", "Macklin",16,512, 1779, [{ id: 14, label: "SRVR"},{ id: 15, label: "HIGHS"}], [16],[
        {"name":"AD", "id": 287},
        {"name": "Alarm", "id": 181},
    ...
    datatile_init("school_info_box_container", "Maymont",715,530, 1519, [{ id: 32}], [19],[
        {"name":"AD", "id": 288},
        {"name": "Alarm", "id": 186},
    ...
    datatile_init("school_info_box_container", "McKitrick",1330,235, 1394, [{ id: 16}], [],[
        {"name":"AD", "id": 289},
        {"name": "Alarm", "id": 191},
    ...
    datatile_init("school_info_box_container", "McLurg",478,345, 2111, [{ id: 17, label: "ELEC"},{ id: 18, label: "LAB"}], [20],[
        {"name":"AD", "id": 290},
        {"name": "Alarm", "id": 197},
    ...
    datatile_init("school_info_box_container", "Medstead",500,188, 1362, [{ id: 19}], [21],[
        {"name":"AD", "id": 291},
        {"name": "Alarm", "id": 202},
    ...
    datatile_init("school_info_box_container", "NBCHS",1540,25, 1301, [{ id: 37, label: "SRVR"},{ id: 21, label: "R206"},{ id: 22, label: "CHEM"},{ id: 23, label: "TELE"},{ id: 24, label: "MAINT"}], [17],[
        {"name":"AD", "id": 292},
        {"name": "Alarm", "id": 207},
    ...
    datatile_init("school_info_box_container", "NCES",484,502, 2593, [{ id: 20}], [22],[
        {"name":"AD", "id": 293},
        {"name": "Alarm", "id": 213},
    ...
    datatile_init("school_info_box_container", "SHS",700,197, 2655, [{ id: 25, label: "SRVR"},{ id: 26, label: "LAB"}], [23],[
        {"name":"AD", "id": 294},
        {"name": "Alarm", "id": 253},
    ...
    datatile_init("school_info_box_container", "St. Vital",1115,700, 2343, [{ id: 27, label: "LIB"},{ id: 28, label: "R104"}], [26],[
        {"name":"AD", "id": 295},
        {"name": "Alarm", "id": 259},
    ...
    datatile_init("school_info_box_container", "UCHS",265,508, 2531, [{ id: 29, label: "SRVR"},{ id: 30, label: "BOIL"}], [24],[
        {"name":"AD", "id": 296},
        {"name": "Alarm", "id": 270},
    ...
    datatile_init("school_info_box_container", "UPS", 265, 663, 2405, [{ id: 31}], [25],[
        {"name":"AD", "id": 297},
        {"name": "Alarm", "id": 271},
