...
$(document).ready(function(){
    ...
    //init_days_since_tile("days_until_container", "DAYS SINCE", "CNET caused an outage", 2023, 1, 31);
    init_days_until_tile("days_until_container", "SLEEPS UNTIL", "IT Job ad closes", 2024, 1, 19);
